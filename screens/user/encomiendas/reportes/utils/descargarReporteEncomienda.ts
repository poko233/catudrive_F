...
export function nombreReporteEncomienda(
  tipo:
    TipoReporteEncomienda,
  ...
  return `reporte-encomiendas-${tipo.replace(
    /_/g,
    "-",
  )}-${fechaArchivo()}.${extension}`;
}
...
export async function descargarReporteEncomienda(
  blob:
    Blob,
        ...
        fileUri,
        {
          ...
          dialogTitle:
            ...
            "application/pdf"
              ...
              : "Guardar o compartir reporte CSV",
          ...(mimeType ===
          "application/pdf"
            ? {
                UTI:
